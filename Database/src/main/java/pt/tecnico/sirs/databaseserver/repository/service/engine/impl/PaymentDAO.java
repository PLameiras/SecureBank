...
public class PaymentDAO extends AbstractDAO<Payment, Long> implements Serializable {
    ...
    public Optional<Payment> getPaymentByAccountFromAndAccountToAndAmountAndDescription(UUID accountFrom, UUID accountTo, BigDecimal amount, String description) {
        try {
